...
f, ax = plt.subplots(subplot_kw={'projection': "mollweide"},figsize=(12,9))
ax.grid(True)
...
ax.set_xlabel("RA-180°",fontsize=20)
...
plt.hist(X,bins=np.linspace(0,2*np.pi,21),color="red")
plt.title('RA',color="navy",fontsize=15)
plt.xlabel('Radians',color="navy",fontsize=15)
plt.savefig("hist1")

plt.figure(figsize=(7,6))
plt.hist(Y,bins=np.linspace(-1,1,21),color="purple")
plt.title("-Cos(DEC+90)",color="navy",fontsize=15)
plt.xlabel('DEC is in degree',color="navy",fontsize=15)
plt.savefig("hist2")